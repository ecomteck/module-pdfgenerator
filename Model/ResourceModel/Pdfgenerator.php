...
namespace Ecomteck\Pdfgenerator\Model\ResourceModel;
...
class Pdfgenerator extends AbstractDb
{
    ...
    {
        $this->_init('ecomteck_pdf_templates', 'template_id');
    }
    ...
    public function lookupStoreIds($templateId)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('ecomteck_pdf_store'),
            'store_id'
        )->where(
            'template_id = ?',
            (int)$templateId
    ...
    public function saveStoreRelation(AbstractModel $template)
    {
        ...
        $table = $this->getTable('ecomteck_pdf_store');
