...
namespace Ecomteck\Pdfgenerator\Setup;

use Ecomteck\Pdfgenerator\Model\Source\TemplatePaperForm;
...
/**
 * Class InstallData
 * @package Ecomteck\Pdfgenerator\Setup
                                            ...
                                            <div class="clearfix header" style="padding: 10px 0; margin-bottom: 20px; border-bottom: 1px solid #AAAAAA;">
                                                <div id="company" style="float: right; text-align: right; width: 49%;">
                                                    <h2 class="name"
                                                        ...
                                                        ecomteck ecommerce solution
                                                    </h2>
                                                    <div>c6 kdt my dinh, Ha Noi, HN 1000 VietNam</div>
                                                    <div>skype: ecomteck</div>
                                                    <div>twitter: ecomteck</div>
                                                    <div><a href="mailto:ecomteck@gmail.com">ecomteck@gmail.com</a></div>
                                                    <div>facebook: <a href="https://facebook.com/ecomteck">fb.com/ecomteck</a></div>
                                                </div>
                                            </div>
                                            <div class="main">
...
',
                ...
                'template_footer' => '
                                    ...
                                    <div style="text-align: center;">Page number {PAGENO}/{nbpg}. Contact us via skype: ecomteck at eny time!</div>\'
